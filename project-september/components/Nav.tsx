...
export const TABS: Tab[] = [
  { id: "today", label: "Aujourd'hui", numeral: "I" },
  { id: "biology", label: "Biologie", numeral: "II" },
  { id: "nutrition", label: "Nutrition", numeral: "III" },
  { id: "training", label: "Entraînement", numeral: "IV" },
  { id: "routine", label: "Routine", numeral: "V" },
  { id: "skincare", label: "Soins", numeral: "VI" },
  { id: "finance", label: "Finance", numeral: "VII" },
  { id: "tracker", label: "Suivi", numeral: "VIII" },
];

export default function Nav({ active, onChange }: { active: string; onChange: (id: string) => void }) {
  return (
    <nav className="relative z-10 sticky top-0 backdrop-blur-md bg-ink-950/80 border-b border-ink-700/60">
